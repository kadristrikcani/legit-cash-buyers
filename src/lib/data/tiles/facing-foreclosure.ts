export const facingForeclosureString = {
  ...
  content: `
  <div class="tiles-content"> <h1 class="tiles-title">Facing Foreclosure? We're Here to Help.</h1>
  ...
  <div class='tiles-row'>
  <div class="tiles-card"> <h2>Common Struggles with Foreclosure:</h2> <ul>
  ...
  <div class="tiles-card"> <h2>How Legit Cash Buyers Can Help</h2> <ul> 
  ...
  <div class="tiles-card"> <h2>Other Options to Stop Foreclosure</h2> <ul> 
  ...
  <p>If you’re facing foreclosure, don't wait. Contact Legit Cash Buyers today to explore your options and find the best solution for your situation. We're here to help you navigate this challenging time and provide a path to financial stability.</p> </div>`
}
