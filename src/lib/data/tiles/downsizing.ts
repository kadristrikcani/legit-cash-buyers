export const downsizingString = {
  ...
  current home quickly. Whether you're moving to a smaller home, a retirement
  community, or simply seeking a more manageable living space, we’re here
  to help you transition smoothly.`,
  testimonials: [
    {
      img: '/logo/app-logo.svg',
      quote:
        'When we decided to downsize, we wanted to avoid the long process of traditional home sales. Legit Cash Buyers made it incredibly easy. They provided a fair cash offer, and we were able to move to our new home quickly and with peace of mind. Highly recommend their services!',
      name: 'Susan W'
    },
    {
      img: '/logo/app-logo.svg',
      quote:
        'As empty nesters, we were ready to move into a smaller home but dreaded the hassle of selling our current house. Legit Cash Buyers offered us a great price and handled everything efficiently. It was the perfect solution for our downsizing needs.',
      name: 'Robert and Linda M'
    },
    {
      img: '/logo/app-logo.svg',
      quote:
        'Downsizing was a big step for us, but Legit Cash Buyers made it smooth and stress-free. They were professional and offered a fair cash deal. We were able to transition to our new home without any complications. Excellent service!',
      name: 'John P'
    },
    {
      img: '/logo/app-logo.svg',
      quote:
        'I needed to downsize due to retirement and wanted a quick sale. Legit Cash Buyers came through with a fair offer and handled all the details. The process was seamless, and I was able to move into my new home with ease. Thank you!',
      name: 'Mary T'
    }
  ],
  faqs: [
    {
      question: 'How fast can I sell my home if I’m downsizing?',
      answer:
    ...
    {
      question: 'How do I get started with Legit Cash Buyers if I’m downsizing?',
      answer:
    ...
    {
      question: 'Can I sell a home that I inherited if I’m downsizing?',
      answer:
        'Yes, we can help you sell an inherited property quickly, providing you with the cash you need to facilitate your downsizing plans.'
    }
  ],
  content: `
  ...
  <div class='tiles-row'> 
  <div class="tiles-card"> <h2>Why Choose Legit Cash Buyers for Your Downsizing Needs?</h2> <ul>
  ...
  <div class="tiles-card"> <h2>Our Downsizing Process</h2>  <ul>
