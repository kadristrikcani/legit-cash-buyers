export const divorceString = {
  ...
  content: `
        <h1>Sell Your Home Quickly and Fairly During Divorce</h1>
        ...
        <h2>Why Choose Legit Cash Buyers for Your Divorce Home Sale?</h2>
        <ul>
        ...
        <h2>Our Divorce Home Selling Process</h2>
        <ul>
            ...
            <li><strong>Get Your Cash:</strong> Receive your cash payment and move forward with your divorce proceedings with peace of mind.</li>
        </ul>
  `
}
