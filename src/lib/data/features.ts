  ...
  features: [
    {
      ...
      mobile: {
        title: 'Foreclosure',
        description: `Don't lose your home to foreclosure. Get a fast, fair cash offer and avoid financial distress.`
      }
    },
    {
      title: `Relocation`,
      ...
      mobile: {
        title: 'Relocation',
        description: `Need to move fast? We offer quick cash deals to help you relocate without stress.`
      }
    },
    {
      ...
      mobile: {
        title: 'Inheritance',
        description: `Selling an inherited property is easy. Get quick cash without managing or repairing the home.`
      }
    },
    {
      title: `Downsizing`,
      ...
      mobile: {
        title: 'Downsizing',
        description: `Looking to downsize? We offer cash for your home, allowing you to move on with ease.`
      }
    },
    {
      title: `Divorce`,
      ...
      mobile: {
        title: 'Divorce',
        description: `Simplify dividing assets during a divorce. We buy homes quickly with fair transactions.`
      }
    },
    {
      ...
      mobile: {
        title: 'Tenants',
        description: `Tired of bad tenants? Sell your rental property quickly and effortlessly, tenant issues or not.`
      }
    },
    {
      title: `Retirement`,
      ...
      mobile: {
        title: 'Retirement',
        description: `Ready to retire and downsize? Sell your home for cash and make your transition smoother.`
      }
    },
    {
      ...
      mobile: {
        title: 'Repairs',
        description: `No need for costly repairs. We buy homes in any condition, providing you with a fair cash offer.`
      }
    }
  ]
}
